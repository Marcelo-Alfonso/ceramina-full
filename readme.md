...
>[!WARNING]
>Es importante que las variables que no empiezan con next_public sean secretas, si se sospecha una filtración se deben generar nuevas lo antes posible  
...
>[!NOTE]
>Luego este nombre se usa en las variables de entorno del frontend como SUPABASE_STORAGE_BUCKET
...
>[!IMPORTANT]
>No se puede hacer la migración sin configurar antes DATABASE_URL en /backend/.env
